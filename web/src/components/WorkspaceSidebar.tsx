...
const SessionRow = memo(function SessionRow({
  ...
  return (
    <>
      <div
        className={`group/row relative flex items-center w-full border-l-2 transition-colors duration-75 ${
          indented ? "" : ""
        } ${
          isActive
            ? "bg-surface-850 border-brand-600"
      ...
      >
        <button
          ...
          className={`flex-1 min-w-0 text-left py-2 cursor-pointer select-none ${
            indented ? "pl-6" : "px-3"
          } pr-1`}
        >
        ...
        {!readOnly && (
          <div className="flex items-center gap-0.5 pr-1.5 shrink-0">
            <button
              ...
              className="w-6 h-6 flex items-center justify-center rounded text-text-dim hover:text-text-secondary hover:bg-surface-600/60 cursor-pointer transition-colors"
            >
            ...
            <button
              ...
              className="w-6 h-6 flex items-center justify-center rounded text-text-dim hover:text-status-error hover:bg-status-error/10 cursor-pointer transition-colors"
            >
              <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
